...
//           </div>
//           {/* <Link href="/login"> */}
//           <div  onClick={handleLoginClick} className="flex items-center justify-between w-[5em] mt-[.4em]">
//             <Image src={user} height={20} width={20} alt="user" />
//             {/* <span>{isLoggedIn ? "Log ud" : "Log ind"}</span> */}
  ...
  return (
    <header className="sticky top-0 bg-white z-[999]">
      <div className="h-[2.5em] w-[100%] bg-[#162A41] text-white flex justify-around">
        ...
        {isLoggedin
          ? <button onClick={handleLogUd}><Image src={user} height={20} width={20} alt="User" />Log ud</button>
          : <Link href="/login" className="flex items-center justify-between w-[5em] mt-[.4em] cursor-pointer"><Image src={user} height={20} width={20} alt="User" />Log ind</Link>
        }
